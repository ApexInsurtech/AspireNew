...
object LossReportFlow {
    ...
    class Initiator(val proposalId: UniqueIdentifier) : FlowLogic<UniqueIdentifier>() {
        ...
        override fun call(): UniqueIdentifier {
            ...
            val output = LossReportState(input.policy_applicant_name, input.policy_applicant_mailing_address,
                    input.broker, input.lead_insurer, input.linearId)


            // Creating the command.
            val commandType = LossReportContract.Commands.Propose()
            ...
            txBuilder.addOutputState(output, LossReportContract.ID)
            ...
            return finalisedTx.tx.outputsOfType<LossReportState>().single().linearId
        }
    }
