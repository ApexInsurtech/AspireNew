...
@InitiatingFlow
@StartableByRPC
class AddLossAmmunttoClaimFlow(val groupID: String, val loss_ammount: Int) : FlowLogic<Unit>() {
    /**
    ...
    override fun call(): Unit {
        ...
        val newGameState = gameState.addLossAmount(loss_ammount)
...
@InitiatedBy(AddLossAmmunttoClaimFlow::class)
class AddLossAmmunttoClaimFlowAcceptor(val otherPartySession: FlowSession) : FlowLogic<SignedTransaction>() {
    @Suspendable
