...
@InitiatingFlow
@StartableByRPC
class AddPolicyIDtoClaimFlow(val groupID: String, val policyID: UniqueIdentifier) : FlowLogic<Unit>() {
    /**
    ...
    override fun call(): Unit {
        ...
        val newGameState = gameState.addPolicyIDtoClaim(policyID)
...
@InitiatedBy(AddPolicyIDtoClaimFlow::class)
class AddPolicyIDtoClaimFlowAcceptor(val otherPartySession: FlowSession) : FlowLogic<SignedTransaction>() {
    @Suspendable
